...
knitr::opts_knit$set(progress = knitverbose, verbose = knitverbose)
...
```{r echo=FALSE, results='asis'}
pandoc.table(by_all, caption=paste("Aggregate Peak Sum by Atomic Count for", paste(element_included_list, collapse = ", "), "."))
```
